...
public class CleanNetwork implements MATSimAppCommand {
	...
	@CommandLine.Parameters(paramLabel = "INPUT", arity = "1", description = "original-input-data/City_2/Network_UY1.xml")
	private Path input;

	@CommandLine.Option(names = "--output", description = "original-input-data/City_2/SIG", required = true)
	private Path output;
